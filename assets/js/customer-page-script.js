...
document.querySelectorAll('.table-row').forEach(row => {
    row.addEventListener('mouseenter', () => {
        ...
        row.style.backgroundColor = 'rgba(139, 195, 74, 0.1)';
...
document.querySelector('#addCustomerBtn').addEventListener('mouseenter', function() {
    this.classList.add('pulse');
});

document.querySelector('#addCustomerBtn').addEventListener('mouseleave', function() {
